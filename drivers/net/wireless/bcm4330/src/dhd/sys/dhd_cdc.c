...
#ifdef SUPPORT_KOR_KT_OPERATOR
	uint assoc_pref = WLC_BAND_5G;
#endif /* SUPPORT_KOR_KT_OPERATOR */
...
#ifdef SUPPORT_KOR_KT_OPERATOR
	/* Prefer 5GHz APs roaming */
	dhd_wl_ioctl_cmd(dhd, WLC_SET_ASSOC_PREFER, (char *)&assoc_pref, 
