...
#define M5MOS_FW_REQUEST_PATH	"/system/etc/firmware/RS_M5LS_S_CELOXHD.bin"	/* SEMKO */
#define M5MOO_FW_REQUEST_PATH	"/system/etc/firmware/RS_M5LS_O_CELOXHD.bin"	/* Optical communication */
#else
