...
#if defined (CONFIG_PMIC8058_XOADC_CAL)
#define CURRENT_OF_FULL_CHG		2100 	/* 170mA */
#else
#define CURRENT_OF_FULL_CHG		2700 	/* 270mA */
#endif /* CONFIG_PMIC8058_XOADC_CAL */
#define RCOMP0_TEMP 			20 	/* 'C */
#elif defined (CONFIG_TARGET_LOCALE_USA)
#if defined (CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_CAN_MODEL_SGH_I577R) || defined(CONFIG_CAN_MODEL_SGH_I757M)
...
#elif defined (CONFIG_KOR_MODEL_SHV_E160K)
#define HIGH_BLOCK_TEMP_ADC_SETTHERM		390
#define HIGH_RECOVER_TEMP_ADC_SETTHERM	    368
#define LOW_BLOCK_TEMP_ADC_SETTHERM		    235
#define LOW_RECOVER_TEMP_ADC_SETTHERM	    248
...
#if defined(CONFIG_TOUCHSCREEN_QT602240) || defined(CONFIG_TOUCHSCREEN_MXT768E) || defined(CONFIG_TOUCHSCREEN_MXT224E)
...
#elif defined  (CONFIG_USA_MODEL_SGH_I717)
	if((get_hw_rev() == 0x01) && (adc_physical > 1290 && adc_physical < 1690))
...
#endif /* CONFIG_PMIC8058_XOADC_CAL */
#elif defined (CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_CAN_MODEL_SGH_I577R) || defined(CONFIG_CAN_MODEL_SGH_I757M)
#if defined (CONFIG_PMIC8058_XOADC_CAL)
const int temper_table[][2] =  {
	/* ADC, Temperature (C) */
	{ 1755,		-100	}, 				
...
static void sec_bat_cable_work(struct work_struct *work)
{
	...
	*/
	...
	case CABLE_TYPE_UARTOFF:
		if (!info->dcin_intr_triggered) {
			printk("%s : jig cable is attached without vbus, skip charging!\n",
				   __func__);
			break;
		} else 
			printk("%s : jig cable is attached with vbus\n",
				   __func__);
#endif
	case CABLE_TYPE_UNKNOWN:
#if defined(CONFIG_TOUCHSCREEN_QT602240) || defined(CONFIG_TOUCHSCREEN_MXT768E) || defined(CONFIG_TOUCHSCREEN_MXT224E)
