...
struct clk_lookup msm_clocks_8x60[] = {
	...
	CLK_8X60("gsbi_uart_clk",	GSBI12_UART_CLK, "msm_serial_hsl.0",
			OFF),
#if !defined(CONFIG_USA_MODEL_SGH_I727) && !defined(CONFIG_USA_MODEL_SGH_T989) && !defined(CONFIG_USA_MODEL_SGH_I717) && !defined(CONFIG_USA_MODEL_SGH_I757)&&! defined (CONFIG_USA_MODEL_SGH_T769)&& !defined(CONFIG_USA_MODEL_SGH_I577) && !defined(CONFIG_CAN_MODEL_SGH_I577R) && !defined(CONFIG_CAN_MODEL_SGH_I757M)//qup_a2220
	...
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_s5k6aafx.0",
#elif defined (CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_CAN_MODEL_SGH_I757M)
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_sr200pc20m.0",
#else
...
#if defined (CONFIG_USA_MODEL_SGH_T769)|| defined (CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_CAN_MODEL_SGH_I577R)
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_s5k6aafx.0",
#elif defined (CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_CAN_MODEL_SGH_I757M)
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_sr200pc20m.0",
#else
...
#if defined (CONFIG_USA_MODEL_SGH_T769)|| defined (CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_CAN_MODEL_SGH_I577R)
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_s5k6aafx.0",
#elif defined (CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_CAN_MODEL_SGH_I757M)
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_sr200pc20m.0",
#else
