...
#elif defined(CONFIG_USA_MODEL_SGH_I727 ) || defined(CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_CAN_MODEL_SGH_I577R)
static struct gpiomux_setting sdcc2_dat_0_3_cmd_actv_cfg = {
	.func = GPIOMUX_FUNC_2,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_UP,
...
#if defined(CONFIG_USA_MODEL_SGH_I727 ) || defined(CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_CAN_MODEL_SGH_I577R)
...
static struct gpiomux_setting touchkey_suspend_cfg = {
    ...
    || defined (CONFIG_USA_MODEL_SGH_T769) || defined (CONFIG_KOR_MODEL_SHV_E160S) || defined (CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L)
...
static struct gpiomux_setting nc_cfg_2 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_HIGH,
...
msm8x60_charm_gpiomux_cfgs[] __initdata = {
    ...
    && !defined(CONFIG_USA_MODEL_SGH_I757)&& !defined (CONFIG_USA_MODEL_SGH_T769) && !defined(CONFIG_USA_MODEL_SGH_I757) && !defined(CONFIG_USA_MODEL_SGH_I577) && !defined(CONFIG_KOR_MODEL_SHV_E120L) && !defined(CONFIG_CAN_MODEL_SGH_I577R) && !defined(CONFIG_CAN_MODEL_SGH_I757M)
	{msm8x60_common_configs, ARRAY_SIZE(msm8x60_common_configs)},
#endif
	{msm8x60_cam_configs, ARRAY_SIZE(msm8x60_cam_configs)},
#ifdef CONFIG_SENSORS_YDA165
