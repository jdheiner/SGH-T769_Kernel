				...
				unsigned long arg)
{
	...
	case WAIT_FOR_RESTART:
		...
		break;
#if defined(CONFIG_KOR_MODEL_SHV_E120L) || defined(CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) \
	|| defined (CONFIG_USA_MODEL_SHV_E120S) || defined (CONFIG_USA_MODEL_SHV_E120K) || defined (CONFIG_JPN_MODEL_SC_03D) || defined(CONFIG_TARGET_LOCALE_USA)
	case RESET_CHARM:
...
#if defined(CONFIG_TARGET_LOCALE_KOR) || defined(CONFIG_TARGET_LOCALE_USA) || defined (CONFIG_JPN_MODEL_SC_03D)
#else
